...
public class LocationUpdatesService extends Service {
    ...
    /**
     * Used to check whether the bound activity has really gone away and not unbound
     * as part of an orientation change. We create a foreground service notification
     * only if the former takes place.
     */
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // We got here because the user decided to remove location updates from the
        // notification.
    ...
    public IBinder onBind(Intent intent) {
        // Called when a client (MainActivity in case of this sample) comes to the
        // foreground
        // and binds with this service. The service should cease to be a foreground
        // service
        // when that happens.
        Log.i(TAG, "in onBind()");
        stopForeground(true);
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(0, "ABRIR APP", activityPendingIntent).addAction(0, "PARAR", servicePendingIntent)
    ...
    private void onNewLocation(Location location) {
        ...
        mLocation = location;
        channel.invokeMethod("callbackLocation", location.getLatitude() + "," + location.getLongitude() + ","
                + location.getSpeed() + "," + serviceIsRunningInForeground(this));
